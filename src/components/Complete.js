    ...
    <section class="screen complete-screen" id="completeScreen">
        <div class="complete-container">
            <div class="complete-header">
                <div class="celebration-badge flex-center">
            ...
            <div class="complete-card card-zen glass">
                <div class="stats-grid flex-center">
                    <div class="stat-item flex-col-center">
                ...
                <div class="log-actions flex-center">
                    <button class="btn-text-only btn-base" id="copyLogBtn" title="Copy Log">
                        <span class="btn-icon-sm" id="copyLogIcon"></span>
                        <span id="copyLogText">${i18n.t('copyLog')}</span>
                    </button>
                    <span class="log-divider">•</span>
                    <button class="btn-text-only btn-base" id="viewLogBtn" title="View Log">
                        <span class="btn-icon-sm" id="viewLogIcon"></span>
                        <span id="viewLogText">${i18n.t('viewLog')}</span>
                    </button>
                    <span class="log-divider">•</span>
                    <button class="btn-text-only btn-base" id="downloadLogBtn" title="Download Log">
            ...
            <div class="complete-actions">
                <button class="btn btn-secondary btn-base" id="takeBreakBtn">
                    <span class="btn-icon" id="takeBreakIcon"></span>
                    <span class="btn-text" id="takeBreakText">${i18n.t('takeBreak')}</span>
                </button>
                <button class="btn btn-primary btn-base" id="newSessionBtn">
